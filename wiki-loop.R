...
FileList <- read.csv("PageList.csv")
for (PAGE in 1:length(FileList$PageName)) {
  input.pagename <- FileList$PageName[PAGE]
  PageEditStat <- FileList$EditCount[PAGE]
